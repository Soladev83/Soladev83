...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=20&duration=3000&pause=800&color=6366F1&center=true&vCenter=true&width=600&lines=Secure+Fullstack+Developer;Cybersecurity+(TryHackMe+Top6%);AI+Integeration" alt="Typing SVG" />
...
🔐 INSA Cyber Talent Graduate by Cybersecurity
...
### ⚡ Sola Electronics — Gadget E-Commerce
Full MERN e-commerce platform with product catalog, cart/wishlist, Stripe checkout, JWT auth, and an admin analytics dashboard. Falls back to an in-memory sandbox mode when MongoDB isn't available.

`React` `Node.js` `MongoDB` `Stripe`

[Repo →](https://github.com/Soladev83/Gadget-E-Commerce-System)
...
[Repo →](https://github.com/Soladev83/Phish-Shield-Mobile-App)
...
Pharmacy management system with inventory and medicine tracking built for real-world pharmacy operations.

`JavaScript` `Full Stack` `Database`

[Repo →](https://github.com/Soladev83/Smart-Pharmacy-System)

</td>
<td width="50%" valign="top">

### 🤖 Anti-Distraction AI
AI-powered application designed to help users stay focused and improve productivity.

`Python` `AI` `Productivity`

[Repo →](https://github.com/Soladev83/Anti-Distraction-AI)
...
Computer vision system that recognizes hand gestures and converts them into meaningful actions in real time.

`Python` `Computer Vision` `AI`

[Repo →](https://github.com/Soladev83/Hand-Gestures-Translator-System)

</td>
<td width="50%" valign="top">

### ✅ To-Do REST API
Clean REST API for task management built with FastAPI, SQLAlchemy, and Pydantic — with optional JWT auth, filtering, pagination, and auto-generated Swagger docs.

`Python` `FastAPI` `SQLAlchemy`

[Repo →](https://github.com/Soladev83/To-Do-REST-API)
